...
class Window: 
    def __init__(self, handle):
        ...
        self.mc = MyArmM("/dev/ttyAMA0", debug=False)
        time.sleep(0.05)
    ...
    def need_input(self):
        ...
        tk.Label(self.frmLT, text="gripper ").grid(row=6)
    ...
    def show_init(self):
        ...
        tk.Label(self.frmLC, text="gripper ").grid(row=5)
...
def main():
    window = tk.Tk()
    window.title("myarm_m750 ros2 GUI")
    Window(window).run()
